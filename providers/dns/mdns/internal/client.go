...
const defaultBaseURL = "https://mdns.nic.md/api/v1/"
...
func (c *Client) AddRecord(ctx context.Context, zone string, record Record) (*AddRecordResponse, error) {
	endpoint := c.baseURL.JoinPath("domain", dns01.UnFqdn(zone), "record")
...
func (c *Client) RemoveRecord(ctx context.Context, zone string, recordID int) error {
	endpoint := c.baseURL.JoinPath("domain", dns01.UnFqdn(zone), "record", strconv.Itoa(recordID))
